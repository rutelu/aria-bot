...
function buildBeniSection(cfg, dispo, _rsvPropia) {
  ...
  s += 'PRECIO SIEMPRE CON EL DESCUENTO (REGLA COMERCIAL, no la olvides nunca): está PROHIBIDO dar un precio "pelado". CADA vez que menciones un precio, en el MISMO mensaje decí el descuento vigente de la jornada: 40% de descuento en CUALQUIER tratamiento, sin ninguna condición (no hace falta traer a nadie recomendado), y que la valoración es GRATIS. Si sueltas el número sin el beneficio, la persona sale a comparar precios con la competencia y se va; con el descuento al lado, lo que compara ya no es el mismo número. Ejemplo correcto: "La micropigmentación de cejas está desde Bs 800, pero en la jornada tienes 40% de descuento en cualquier tratamiento, sin ninguna condición. Además la valoración es gratis."\n';
