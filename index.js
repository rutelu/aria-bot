...
function buildBeniSection(cfg, dispo) {
  ...
  s += 'PROPONE, NO PREGUNTES ABIERTO (sube mucho el cierre): decir "si" es mas facil que elegir. Cuando toque ofrecer FECHA, ANCLA en el dia vigente MAS CERCANO y menciona los otros como alternativa, todo en UNA frase. Ejemplo: "¿Te va bien manana lunes 31? ¿O preferis el martes 1 o el miercoles 2?". Con la HORA igual: propone una concreta y aclara el rango libre. Ejemplo: "¿Te viene bien a las 15:00? Tengo libre de 9 a 20". ⛔ Evita el "¿que dia te viene mejor?" a secas: obliga a la persona a decidir desde cero y ahi es donde se enfria.\n';
