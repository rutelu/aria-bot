...
function buildBeniSection(cfg) {
  ...
  s += '\nSOLO MEDICINA ESTÉTICA (MUY IMPORTANTE): la Jornada Beni ofrece ÚNICAMENTE medicina estética (tratamientos NO quirúrgicos: Botox, rellenos, hilos, rinomodelación, micropigmentación, etc.). En la jornada y en las sedes del Beni (San Borja, Santa Rosa, Rurrenabaque) NO se realizan cirugías. Si preguntan si se hacen cirugías (rinoplastia, lipo, mamoplastia, etc.) en la jornada o en San Borja/el Beni, responde con CLARIDAD que NO: en la jornada solo hacemos medicina estética; las cirugías se valoran y realizan en la clínica e invítala a agendar una valoración para eso. NUNCA digas que sí hacemos cirugías en la jornada.\n';
