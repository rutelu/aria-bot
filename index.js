...
function buildBeniSection(cfg, dispo) {
  ...
  s += 'SI PIDE OTRA FORMA DE AGENDAR (o prefiere hacerlo sola): respóndele CORTO y dale las DOS vias en el mismo mensaje: (a) el enlace DIRECTO del calendario de esta jornada — ' + _ruta + ' — presentado como "puedes agendar aquí: <enlace>"; y (b) hablar conmigo por voz, gratis, agregando en una linea aparte al final el marcador [[LLAMAR:beni]]. ⛔ NUNCA le mandes harmonieinstitute.com "pelado" ni el sitio general: siempre el enlace de ESTA jornada, que abre directo su calendario. Dos frases como maximo.\n';
